...
#define BPLIB_NC_NODE_MIB_CONFIG_NUM    5       /** \brief Number of Node MIB configurations */
#define BPLIB_NC_SOURCE_MIB_CONFIG_BASE 4       /** \brief Base enumeration of source MIB configurations */
...
typedef enum
{
    ...
    PARAM_SET_MAX_LIFETIME                = 4,  /** \brief Max bundle lifetime for retention of the bundle */

    /* Source-only configs */
    PARAM_SET_MAX_BSR_GENERATION_RATE     = 5,  /** \brief Maximum number of BSRs per minute that a node can generate overall and on behalf of each source */
    PARAM_SET_MAX_CBR_GENERATION_RATE     = 6,  /** \brief Maximum number of CBRs per minute that a node can generate overall and on behalf of each source */
    BUNDLE_SET_BEHAVIOR_RCVD_BSR_GENERATE = 7,  /** \brief Flag indicating that BSR should be generated for bundles received */
    BUNDLE_SET_BEHAVIOR_ACPT_BSR_GENERATE = 8,  /** \brief Flag indicating that BSR should be generated for bundles accepted to custody */
    BUNDLE_SET_BEHAVIOR_FWRD_BSR_GENERATE = 9,  /** \brief Flag indicating that BSR should be generated for bundles forwarded */
    BUNDLE_SET_BEHAVIOR_DLVR_BSR_GENERATE = 10, /** \brief Flag indicating that BSR should be generated for bundles delivered */
    BUNDLE_SET_BEHAVIOR_DLTD_BSR_GENERATE = 11, /** \brief Flag indicating that BSR should be generated for bundles deleted */ 
    BUNDLE_SET_BEHAVIOR_RCVD_CBR_GENERATE = 12, /** \brief Flag indicating that CBR should be generated for bundles received */
    BUNDLE_SET_BEHAVIOR_ACPT_CBR_GENERATE = 13, /** \brief Flag indicating that CBR should be generated for bundles accepted to custody */
    BUNDLE_SET_BEHAVIOR_FWRD_CBR_GENERATE = 14, /** \brief Flag indicating that CBR should be generated for bundles forwarded */
    BUNDLE_SET_BEHAVIOR_DLVR_CBR_GENERATE = 15, /** \brief Flag indicating that CBR should be generated for bundles delivered */
    BUNDLE_SET_BEHAVIOR_DLTD_CBR_GENERATE = 16, /** \brief Flag indicating that CBR should be generated for bundles deleted */
} BPLib_NC_Config_t;
